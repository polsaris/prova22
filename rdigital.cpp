...
void RDigital::botons() {
    QPixmap blanc("/home/pi/prova20/imatges/blanc4.jpg");
    QIcon b_blanc(blanc);
    ui->c_blanc->setIcon(b_blanc);
    ui->c_blanc->setIconSize(QSize(97,97));

    QPixmap negre("/home/pi/prova20/imatges/negre2.jpg");
    QIcon b_negre(negre);
    ui->c_negre->setIcon(b_negre);
    ui->c_negre->setIconSize(QSize(97,97));

    QPixmap fubuntu("/home/pi/prova20/imatges/fontubuntu2.jpg");
    ...
    QPixmap esquerra("/home/pi/prova20/imatges/esquerra.jpg");
